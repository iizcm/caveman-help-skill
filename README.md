...
cp -r productivity/caveman-help ~/.hermes/skills/productivity/caveman-help/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/caveman-help-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/caveman-help-skill.git ~/.hermes/skills/productivity/caveman-help/
```
...
```text
skill_view(name="productivity/caveman-help")
```
...
```text
Use the caveman help skill to <describe your specific task here>
```
...
```text
Gunakan skill caveman help untuk <deskripsikan tugas spesifik Anda di sini>
```
